...
const resolvers = {
  ...
  Mutation: {
    ...
    //     console.log(filename + '  you reached the file on line 275');
    ...
    //     console.log(result);
    //     console.log({ result });
    //     console.log('you reached cloudinary');
    //     if (err) {
    //       console.warn(err);
    //     }
    ...
    // waitForAllUploads(pathname, err, results);
    // const user = User.findByIdAndUpdate(
    //   { _id: context.user._id },
    //   { $set: { primaryPhoto: result }},
    //   { new: true }
    // );
    // console.log('* ' + result.url);
    // waitForAllUploads(name, err, result);
    // console.log(user + 'now inside the cloudinary code');
