...
//   });
  ...
  // Display image as preview once it's selected by user (before form submission)
  useEffect(() => {
    if (selectedImage) {
  ...
  const handleFormSubmit = async (event) => {
    ...
    try {
      // selectedImage console.log coming through
      ...
      //   now we upload the file the user selected
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* if image selected display small preview */}
